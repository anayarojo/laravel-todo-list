...
class ListController extends Controller
{
    ...
    {
        $lists = $category && $category->id ? $category->lists : JWTAuth::user()->lists;
    ...
    {
        $list = $category && $category->id ? $category->lists()->create($request->all()) : JWTAuth::user()->lists()->create($request->all());
